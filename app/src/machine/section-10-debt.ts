...
export const section10DebtStates = {
  ...
  section_10_debt_intro: {
    meta: {
      ...
      title: 'Section 10D: Distributor Core - Debt-Tangled Lock Order',
  ...
  section_10_exit: {
    meta: {
      ...
      title: 'Section 10 Exit: Sign Off Or Pull The Thread',
      text:
      ...
      NEXT: [
        {
          ...
          target: 'ending_4',
          actions: [{ type: 'set', params: { accepted_exit_10: true } }, { type: 'score', params: { technical: 0, dedication: -1, social: 0 } }],
        },
        {
