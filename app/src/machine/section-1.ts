...
export const section1States = {
  ...
  section_1: {
    ...
    on: {
      NEXT: [
        { guard: ({ event }: any) => event.answer === 'standard', target: 'section_1_conclusion_standard', actions: [{ type: 'set', params: { boot_mode: 'standard' } }, { type: 'score', params: { technical: 0.4, dedication: 0.3, social: 0 } }] },
        { guard: ({ event }: any) => event.answer === 'unsigned', target: 'section_1_conclusion_unsigned', actions: [{ type: 'set', params: { boot_mode: 'unsigned' } }, { type: 'score', params: { technical: -0.3, dedication: -0.2, social: 0 } }] },
      ],
    },
  },
